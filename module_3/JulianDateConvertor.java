...
public class JulianDateConvertor {
    ...
    /**
     * This constructor will take dateString as an input in <b>DDMMYYYY</b>
     format
    ...
    /**
     * This constructor will take the juilianNumber and set the attribute
     *juilianNumber.
     *
     * @param julianNumber
     */
    ...
    /**
     * This constructor take day, month, and year as an input and set the
     ...
     * Then it will create a date string in <b>DD-MM-YYYY</b> format and will
     return date string.
     *
     * @return Date String
     */
